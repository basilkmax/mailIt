...
<title>getHobbyFactorDetails</title>
</head>
...
String thobbyid=request.getParameter("d");
...
String sql="select * from hobbyfactor_tb where hobby_id='"+thobbyid+"'";
...
System.out.println("factorid from gethobbydetails:"+tempfactorid);

String sql1="select * from userhobbycustom_tb where username='"+tusername+"' and factorid='"+tempfactorid+"'";
