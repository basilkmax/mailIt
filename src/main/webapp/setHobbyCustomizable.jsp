...
<title>setHobbyCustomizable</title>
</head>
<body>
...
String sql1="delete from userhobbycustom_tb where username='"+tusername+"' and factorid='"+item+"'";
...
String sql="insert into userhobbycustom_tb values(null,'"+tusername+"','"+item+"')";
...
r=obj.ForExecute(sql);
  ...
  if(r>0)
response.sendRedirect("hobbyCustomize.jsp?msg7=success");
 else
response.sendRedirect("hobbyCustomize.jsp?msg7=error");
